...
MISTRAL_MODEL         = "gemini-2.5-flash"
...
1. SIGNAL (Keep):
   - Bangladesh National Impact: Macroeconomic data (inflation, reserves, remittance, trade), central bank/cabinet decisions, national budget, nationwide policy rollouts, Supreme Court/Election Commission rulings, national infrastructure/system failures.
   - Foreign Affairs & Bilateral: Official bilateral talks, cross-border disputes/agreements, foreign loans or aid formally approved, international pressure/sanctions.
   - Global Geopolitics & Systemic Events: Armed conflicts between states, decisions by major international bodies (UN, IMF, World Bank, NATO, WTO, IAEA, ICC/ICJ), major treaty changes, global energy/financial disruptions.

2. NOISE (Discard):
   - Isolated Incidents: Single arrest, crime, accident, fire, local clash, or single-location protest.
   - Local/Sub-national Scope: Events affecting only one district, one institution, or one individual.
